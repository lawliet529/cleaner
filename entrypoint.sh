...
echo "$CLEAN_SCHEDULE /bin/sh -c '. /etc/cleanup_env; /cleanup.sh >> /var/log/cleaner.log 2>&1'" > /etc/crontabs/root
...
crond -L /var/log/cleaner.log
tail -F /var/log/cleaner.log